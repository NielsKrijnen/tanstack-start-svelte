...
import { getStoreFactory } from "./routerStores.svelte"
...
declare module "@tanstack/router-core" {
  export interface RouterOptionsExtensions {
     ...
     * @link [Guide](https://tanstack.com/router/latest/docs/framework/svelte/guide/data-loading#handling-errors-with-routeoptionsoncatch)
     */
...
> extends RouterCore<TRouteTree, TTrailingSlashOption, TDefaultStructuralSharingOption, TRouterHistory, TDehydrated> {
  constructor(
